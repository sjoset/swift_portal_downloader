...
def main():
    ...
    while (True):
        ...
        if (user_input_1 == 'q'): # User selected quit
            return

        elif (user_input_1 == 'i'): # User selected info
        ...
        elif (user_input_1 == 'n'): # User selected name_scheme
            console.clear()
            ...
            while(True):
                ...
                if(user_input_2 == 'q'): # User selected return to level 1, break out of level 2
                    console.clear()
                    break

                elif(user_input_2 == '0'): # User selected add new names
                    print()
                ...
                elif(user_input_2 == '1'): # User selected remove name
                    print()
        ...
        elif (user_input_1 == '0'): # User selected search
            console.clear()
            ...
            while(True):
                ...
                if (user_input_3 == 'q'): # User selected to return to level 1, break out of level 2
                    console.clear()
                    break

                elif (user_input_3 == '0'): # User selected mass download
                ...
                elif (user_input_3 == '1'): # User selected specific search term
                    search_term = input(f"\nSearch term (press q to return to main menu): ")

                    if (search_term == 'q'): # Search term specified to return to level 1, breaking out of level 2
                        console.clear()
                        break
